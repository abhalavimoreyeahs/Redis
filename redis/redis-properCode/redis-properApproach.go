// Or an alternative, and arguably neater,
// approach is to use the redis.Values() and redis.ScanStruct() functions to automatically
// unpack the data to the Album struct, like so,
